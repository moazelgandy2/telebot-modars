      ...
      .then((data) => {
        if (data.success && data.data) {
          setSettings({
            ...
            responseDelay: data.data.responseDelay || '0',
          });
        }
      })
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-muted/30 rounded-xl border border-border/50 p-4 space-y-4">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-background border border-border/40 shadow-sm">
                  <div className="space-y-0.5">
                    <label className="text-sm font-medium">تأخير الرد (ثواني)</label>
                    <p className="text-xs text-muted-foreground">عدد ثواني الانتظار قبل الرد</p>
                  </div>
                  <Input
                    name="responseDelay"
                    type="number"
                    ...
                    className="w-20 h-8 text-center text-sm bg-muted/50 border-border/50 focus:border-primary/50 focus:ring-0 transition-all font-mono"
                  />
                </div>
              </div>
            </div>
